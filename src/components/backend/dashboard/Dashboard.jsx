    ...
    return (
        <>
            ...
            <div className="bg-image overflow-hidden"
                 style={{backgroundImage: "url('assets/media/photos/photo3@2x.jpg')"}}>
                <div className="bg-primary-dark-op">
                    <div className="content content-narrow content-full">
                        <div
                            className="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center mt-5 mb-2 text-center text-sm-left">
                            <div className="flex-sm-fill">
                                <h1 className="font-w600 text-white mb-0 invisible" data-toggle="appear">Dashboard</h1>
                                <h2 className="h4 font-w400 text-white-75 mb-0 invisible" data-toggle="appear"
                                    data-timeout="250">Welcome Administrator</h2>
                            </div>
                    ...
                    <div className="col-lg-6">
                        <div className="block block-rounded block-mode-loading-oneui">
                            ...
                            <div className="block-content p-0 text-center">
                                ...
                                {/* <!-- For more info and examples you can check out http://www.chartjs.org/docs/ --> */}
                                <div className="pt-3" style={{height: 360}}>
                                    <canvas className="js-chartjs-dashboard-sales"></canvas>
                                </div>
                            </div>
                            <div className="block-content">
                                <div className="row items-push text-center py-3">
                            ...
                            <div className="block-content block-content-full">
                                <table
                                    ...
                                    <tr className="text-uppercase">
                                        ...
                                        <th className="d-none d-sm-table-cell font-w700 text-center"
                                            style={{width: 100}}>Photo
                                        </th>
                                        <th className="font-w700">Name</th>
                                        <th className="d-none d-sm-table-cell font-w700 text-center"
                                            style={{width: 80}}>Orders
                                        </th>
                            ...
                            <div className="block-content block-content-full">
                                <table
                                    ...
                                    <tr className="text-uppercase">
                                        ...
                                        <th className="d-none d-sm-table-cell font-w700 text-right"
                                            style={{width: 120}}>Price
                                        </th>
                                        <th className="font-w700 text-center" style={{width: 60}}></th>
                                    </tr>
                                    </thead>
